...
import com.zx.module_supervise.module.task.mvp.model.TaskDisposeModel
import com.zx.module_supervise.module.task.mvp.presenter.TaskDisposePresenter
 ...
 */
@SuppressLint("NewApi")
@Route(path = RoutePath.ROUTE_SUPERVISE_TASK_DISPOSE)
class TaskDisposeActivity : BaseActivity<TaskDisposePresenter, TaskDisposeModel>(), TaskDisposeContract.View {
    ...
    companion object {
        ...
        fun startAction(activity: Activity, isFinish: Boolean, fId: String, fTaskId: String, fEntityGuid: String, status: String) {
            val intent = Intent(activity, TaskDisposeActivity::class.java)
