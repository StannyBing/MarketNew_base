...
interface DailyAddContract {
    ...
    interface View : IView {
        ...
        fun onEntityDetailResult(entityBean: EntityBean?)
    }
    ...
    interface Model : IModel {
        ...
        fun getBizlicNumDetail(map: Map<String, String>): Observable<EntityBean>
    ...
    abstract class Presenter : BasePresenter<View, Model>() {
        ...
        abstract fun getEntityByBizlicNum(map: Map<String, String>)
    }
}
