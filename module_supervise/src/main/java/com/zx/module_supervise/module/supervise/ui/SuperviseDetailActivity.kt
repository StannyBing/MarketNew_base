...
import com.zx.module_supervise.module.supervise.mvp.model.SuperviseDetailModel
import com.zx.module_supervise.module.supervise.mvp.presenter.SuperviseDetailPresenter
...
class SuperviseDetailActivity : BaseActivity<SuperviseDetailPresenter, SuperviseDetailModel>(), SuperviseDetailContract.View {
    ...
    override fun onViewListener() {
        ...
        btn_supervise_dispose.setOnClickListener {
            if (entityInfoBean != null) {
                SuperviseDisposeActivity.startAction(this, false, id, taskId, entityInfoBean!!.fEntityGuid, entityInfoBean!!.fStatus!!)
            } else {
                showToast("未获取到主体信息")
            }
        }
