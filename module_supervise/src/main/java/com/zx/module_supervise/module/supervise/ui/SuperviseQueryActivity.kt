...
import com.zx.module_supervise.module.supervise.func.adapter.SuperviseListAdapter
import com.zx.module_supervise.module.supervise.mvp.contract.SuperviseQueryContract
import com.zx.module_supervise.module.supervise.mvp.model.SuperviseQueryModel
import com.zx.module_supervise.module.supervise.mvp.presenter.SuperviseQueryPresenter
...
class SuperviseQueryActivity : BaseActivity<SuperviseQueryPresenter, SuperviseQueryModel>(), SuperviseQueryContract.View {
    ...
    companion object {
        ...
        fun startAction(activity: Activity, isFinish: Boolean) {
            val intent = Intent(activity, SuperviseQueryActivity::class.java)
    ...
    override fun onSuperviseListResult(superviseList: NormalList<SuperviseListBean>) {
        ...
        tv_supervise_tips.text = "检索到${type}共${superviseList.total}条"
        sr_supervise_list.refreshData(superviseList.list, superviseList.total)
    }
