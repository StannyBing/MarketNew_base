...
interface ApiService {
    ...
    @GET(ApiConfigModule.URL_SUPERVISE + "taskStatistics/taskMonitoring.do")
    fun getSuperviseList(@QueryMap map: Map<String, String>): Observable<BaseRespose<SuperviseListBean>>
