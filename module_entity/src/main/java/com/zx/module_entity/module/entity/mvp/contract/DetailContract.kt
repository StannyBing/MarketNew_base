...
interface DetailContract {
    ...
    interface View : IView {
        fun onEntityDetailResult(entityDetail : EntityDetailBean?)
    }

    //Model层定义接口,外部只需关心Model返回的数据,无需关心内部细节,即是否使用缓存
    interface Model : IModel {
        fun entityDetailNormalData(map: Map<String, String>) : Observable<EntityDetailBean>
    ...
    abstract class Presenter : BasePresenter<View, Model>() {
        abstract fun getEntityDetail(type : Int, map: Map<String, String>)
    }
}
