 ...
 * 功能：任务通用适配器
 */
class TaskAdapter(databeans: List<TaskBean>) : ZXQuickAdapter<TaskBean, ZXBaseHolder>(R.layout.item_task_normal, databeans) {
    override fun convert(helper: ZXBaseHolder?, item: TaskBean?) {
